 ...
 * `const` tuple, same pattern as DRIVER_STATUSES etc. in driver/drivers.types.ts, so a call
...
export const AUDIT_ACTIONS = [
  ...
  'DRIVER_REJECTED',
  'DRIVER_INVITED',
  'DRIVER_LINK_ACCEPTED',
  'DRIVER_LINK_DECLINED',
