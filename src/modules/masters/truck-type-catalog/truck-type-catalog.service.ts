...
import { DEFAULT_TRUCK_TYPES } from '../truck-type/truck-type.constants';
import { TRUCK_TYPE_CATALOG_CONFIGURATIONS } from './truck-type-catalog-configurations.constants';
