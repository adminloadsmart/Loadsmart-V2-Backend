...
const fields = {
  ...
  contactPersonName: z.string().trim().min(1).max(150).optional(),
  contactPersonNumber: mobile.optional(),
  contactPersonEmail: z.string().trim().email().max(255).optional(),
  contactPersonDesignation: z.string().trim().min(1).max(100).optional(),
  contactPersonDesignationOther: z.string().trim().min(1).max(100).optional(),
  ...
  update: z.object({
    ...
    body: z
      .object({
        ...
        contactPersonName: fields.contactPersonName.nullable(),
        contactPersonNumber: fields.contactPersonNumber.nullable(),
        contactPersonEmail: fields.contactPersonEmail.nullable(),
        contactPersonDesignation: fields.contactPersonDesignation.nullable(),
        contactPersonDesignationOther: fields.contactPersonDesignationOther.nullable(),
