...
export const ORGANIZATION_ONBOARDING_STEPS = ['company_details', 'business_details', 'review_submit', 'submitted'] as const;
...
export class OrganizationEntity {
    ...
    @Column({ name: 'onboarding_step', type: 'enum', enum: ORGANIZATION_ONBOARDING_STEPS, nullable: true })
