...
export class CreateLoadsTable1786900000001 implements MigrationInterface {
  name = 'CreateLoadsTable1786900000001';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP TYPE "loads"."loads_freight_mode_enum"`);
