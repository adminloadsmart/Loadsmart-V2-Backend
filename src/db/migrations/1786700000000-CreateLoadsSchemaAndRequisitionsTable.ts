...
export class CreateLoadsSchemaAndRequisitionsTable1786700000000 implements MigrationInterface {
  name = 'CreateLoadsSchemaAndRequisitionsTable1786700000000';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "loads"."requisitions" ADD CONSTRAINT "FK_e14fb7ad2800569387c3e597cfd" FOREIGN KEY ("product_id") REFERENCES "masters"."products"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "loads"."requisitions" DROP CONSTRAINT "FK_e14fb7ad2800569387c3e597cfd"`,
    );
    await queryRunner.query(
    ...
    // "storage" — later loads-module migrations (loads/load_payments/load_activities) also own it.
  }
}
